          ...
          <PrevNext prev={prev} next={next}>
            <table>
              ...
              <tbody>
                ...
                <tr>
                  <BigTd>
                    Среднa вредност на ноќната потрошувачка на мали потрошувачи
                    од стопанството, l/h
                  </BigTd>
                  <SmallTd colSpan={1}>
                    <NumberInput
                ...
                <tr>
                  <BigTd>
                    Ноќна потрошувачка на големи потрошувачи од стопанството,
                    l/h
                  </BigTd>
                  <SmallTd colSpan={1}>
                    <NumberInput
                ...
                <tr>
                  <td colSpan={6}>
                    2.Предефинирани параметри за загубите на вода
                  </td>
                </tr>
              ...
              "
                ...
                <tr>
                  ...
                  >
                    Експонент на притисокот, во услови кога дефектите во
                    позадина и дефекти во водоводната мрежа се третираат како
                    една компонента
                  </WithTooltip>
                  <SmallTd colSpan={1}>
                    <NumberInput
                ...
                <tr>
                  <BigTd>
                    IWA стандардна вредност за истекувањето од еквивалентен
                    дефект при притисок од 50 m, m<sup>3</sup>/h
                  </BigTd>
                  <SmallTd colSpan={1}>
                    <NumberInput
                      value={
                        data.standardEquivalentServicePipeBurstAt50mPressure
                      }
                      onChange={change(
                ...
                <tr>
                  ...
                  >
                    Вкупна легална ноќна потрошувачка на корисниците, m
                    <sup>3</sup>/h
                  </WithTooltip>
                  <Highlighted colSpan={1}>
                ...
                <tr>
                  ...
                  >
                    Неочекувани загуби на вода (неоткриени дефекти), m
                    <sup>3</sup>/h
                  </WithTooltip>
                  <Highlighted colSpan={1}>
                ...
                <tr>
                  ...
                  >
                    Проток независен од работниот притисок во мрежата, m
                    <sup>3</sup>/h
                  </WithTooltip>
                  <Highlighted colSpan={1}>
                ...
                <tr>
                  ...
                  >
                    Проток зависен од работниот притисок во мрежата, m
                    <sup>3</sup>/h
                  </WithTooltip>
                  <Highlighted colSpan={1}>
