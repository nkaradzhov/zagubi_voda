...
const prev = { to: '/page1', tooltip: 'Мерени податоци' }
const next = { to: '/page3', tooltip: 'Сценарио I: Редуктор со фиксен излез' }
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                >
                  Експонент на притисокот, во услови кога дефектите во позадина
                  и дефекти во водоводната мрежа се третираат како една
                  компонента
                </WithTooltip>
                <SmallTd colSpan={1}>
                  <NumberInput
